...
class DailyUpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_update" do
    assert_difference('DailyUpdate.count') do
      post daily_updates_url, params: { daily_update: { body: @daily_update.body, date: @daily_update.date, title: @daily_update.title } }
    end
  ...
  test "should update daily_update" do
    patch daily_update_url(@daily_update), params: { daily_update: { body: @daily_update.body, date: @daily_update.date, title: @daily_update.title } }
