class DailyUpdatesController < ApplicationController
  ...
  # GET /daily_updates
  # GET /daily_updates.json
  def index
    @daily_updates = DailyUpdate.all
  end

  # GET /daily_updates/1
  # GET /daily_updates/1.json
  def show
  end
  ...
  # POST /daily_updates
  # POST /daily_updates.json
  def create
    @daily_update = DailyUpdate.new(daily_update_params)

    respond_to do |format|
      if @daily_update.save
        format.html { redirect_to @daily_update, notice: 'Daily update was successfully created.' }
  ...
  # PATCH/PUT /daily_updates/1
  # PATCH/PUT /daily_updates/1.json
  def update
    respond_to do |format|
      if @daily_update.update(daily_update_params)
        format.html { redirect_to @daily_update, notice: 'Daily update was successfully updated.' }
  ...
  # DELETE /daily_updates/1
  # DELETE /daily_updates/1.json
  def destroy
  ...
  private
    ...
    def daily_update_params
      params.require(:daily_update).permit(:date, :title, :body, :text)
    end
end
